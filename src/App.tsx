...
import { ThemeProvider } from './contexts/ThemeContext'; // Assume que ThemeContext está funcionando
...
const App: React.FC = () => {
  ...
  const [currentViewTitle, setCurrentViewTitle] = useState<string>('Monitoramento'); // Valor inicial
  ...
  return (
    ...
    <ThemeProvider>
      ...
      <Router>
        <div className="app-layout"> {/* Classe principal do layout */}
          ...
          <div className={`main-content-wrapper ${sidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
            ...
            <main className="content-area">
              ...
              <Routes>
                ...
                <Route path="/bancos-restaurados" element={<ProcessedDatabasesPage />} />
